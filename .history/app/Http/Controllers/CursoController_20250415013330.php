...
namespace App\Http\Controllers; // O App\Http\Controllers\Admin si está ahí
...
use Illuminate\Support\Facades\Gate; // Importa Gate si lo usas
...
class CursoController extends Controller
{
    ...
    public function update(Request $request, Curso $curso) // Usar Route Model Binding
    {
        ...
        // ¡USA EL NOMBRE CORRECTO DE LA RUTA!
    ...
    // --- ¡NO DEBE HABER JAVASCRIPT AQUÍ! ---

} // Fin de la clase CursoController
