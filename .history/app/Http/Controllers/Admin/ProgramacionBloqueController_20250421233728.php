...
use Illuminate\Support\Facades\Log; // Necesario para Log::error
...
class ProgramacionBloqueController extends Controller
{
    ...
    public function ordenar(Request $request)
    {
        ...
        return view('admin.programaciones.bloque.ordenar', compact('grupo', 'cursosSeleccionados'));
    }

    // --- Métodos Pendientes ---

    // TODO: Método para guardar el bloque ordenado y crear programaciones
