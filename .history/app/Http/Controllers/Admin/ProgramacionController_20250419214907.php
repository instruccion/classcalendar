        ...
        try {
            ...
            while ($minutosRestantes > 0) {
                ...
                if ($fechaActual->format('H:i') < '12:00') {
                    $minutosAntesAlmuerzo = min(12 * 60, ($fechaActual->hour * 60 + $fechaActual->minute));
                    $minutosDisponiblesHoy += (12 * 60) - $minutosAntesAlmuerzo;
                    $fechaActual->setTime(13, 0);
                } elseif ($fechaActual->format('H:i') < '13:00') {
                    $fechaActual->setTime(13, 0);
                }

                if ($fechaActual->format('H:i') >= '13:00' && $fechaActual->format('H:i') < '17:00') {
                    $minutosAntesFin = ($fechaActual->hour * 60 + $fechaActual->minute);
                    $minutosDisponiblesHoy += (17 * 60) - $minutosAntesFin;
                }
