     ...
     */
     public function showProgramarBloque()
     {
        ...
        public function calcularFechaFinApi(Request $request)
        {
            ...
            try {
                // --- RESPUESTA TEMPORAL MUY SIMPLE ---
                // Simplemente devuelve la misma fecha de inicio y una hora fija
                $fechaFinTentativa = Carbon::parse($validated['inicio']);
                $horaFinTentativa = '17:00'; // Placeholder fijo
                ...
                // Devolver un error claro para JS
