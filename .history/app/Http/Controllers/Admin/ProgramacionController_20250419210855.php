...
class ProgramacionController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($user->coordinacion_id) {
            ...
            ->with('coordinacion', 'cursos')->orderBy('nombre')->get();
    ...
    public function store(Request $request)
    {
        ...
        $diasNecesarios = ceil($duracionHoras / 8);
        ...
        while ($diasHabilesContados < $diasNecesarios) {
            ...
            while ($fechaFinCalculada->isWeekend() || in_array($fechaFinCalculada->format('Y-m-d'), $feriados)) {
                $fechaFinCalculada->addDay();
            }
            $diasHabilesContados++;
        }
        $horaFinCalculada = '17:00:00';
    ...
    // ... el resto del controlador permanece sin cambios ...
}
