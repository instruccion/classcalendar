    ...
    public function index(Request $request)
    {
        ...
        $eventos = $programaciones->map(function ($p) {
            return [
                ...
                'start' => \Carbon\Carbon::parse("{$p->fecha_inicio} {$p->hora_inicio->format('H:i:s')}")->toIso8601String(),
                'end' => \Carbon\Carbon::parse("{$p->fecha_fin} {$p->hora_fin->format('H:i:s')}")->toIso8601String(),
