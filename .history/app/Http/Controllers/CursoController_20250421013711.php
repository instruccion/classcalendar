...
class CursoController extends Controller
{
    ...
    public function edit(Curso $curso)
    {
        ...
        $todos_grupos = $usuario->esAdministrador() && is_null($usuario->coordinacion_id)
            ? Grupo::select('id', 'nombre')->orderBy('nombre')->get()
            : Grupo::where('coordinacion_id', $usuario->coordinacion_id)->select('id', 'nombre')->orderBy('nombre')->get();
