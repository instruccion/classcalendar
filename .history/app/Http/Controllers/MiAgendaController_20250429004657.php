...
class MiAgendaController extends Controller
{
    ...
    {
        $usuario = auth()->user();
        $instructor = $usuario->instructor; // Esto ahora SIEMPRE obtiene al instructor real vinculado
        ...
        ->where('instructor_id', $instructor->id)  // <--- USANDO EL INSTRUCTOR DEL USUARIO LOGUEADO
