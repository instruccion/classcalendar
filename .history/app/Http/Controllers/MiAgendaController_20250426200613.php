        ...
        $eventos = $programaciones->map(function ($p) {
            ...
            return [
                ...
                'extendedProps' => [
                    ...
                    'estadoDisplay' => ucfirst($p->estado_confirmacion ?? 'pendiente'), // esto lo pedía tu modal
                    'fecha_inicio_fmt' => $p->fecha_inicio ? $p->fecha_inicio->format('d/m/Y') : '—', // esto también
                    'fecha_fin_fmt' => $p->fecha_fin ? $p->fecha_fin->format('d/m/Y') : '—', // esto también
                ],
            ];
        });
