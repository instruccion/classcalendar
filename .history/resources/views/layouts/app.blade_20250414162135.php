...
<head>
    ...
    <style>
        /* Tailwind's default transition doesn't include the overlay. You might want to add custom behavior */
        .sidebar-hidden {
            display: none;
        }
        .sidebar-visible {
...
<body class="bg-gray-100 text-gray-800">
    ...
    {{-- SIDEBAR --}}
    <aside id="sidebar"
        class="fixed top-16 left-0 bottom-0 w-64 bg-white border-r border-gray-300 p-4 z-40 transition-all duration-300 ease-in-out sidebar-hidden lg:sidebar-visible">
    ...
    <script>
        ...
        // Cierre del sidebar con overlay
        ...
        // Sincronizar márgenes de contenido principal
