...
<body class="bg-gray-100 text-gray-800">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="relative">
                <div class="flex items-center gap-3 cursor-pointer" id="avatar-btn">
                    ...
                    <img src="{{ asset('assets/images/users/avatar-default.png') }}"
    ...
    {{-- SIDEBAR --}}
    <aside id="sidebar" class="fixed top-16 left-0 bottom-0 w-64 bg-white border-r border-gray-300 p-4 z-40 transition-transform transform translate-x-0">
    ...
    {{-- CONTENIDO --}}
    <main id="main-content" class="ml-64 mt-16 p-6 min-h-[calc(100vh-8rem)] pb-20 transition-all duration-300">
        {{ $slot }}
    </main>
