        ...
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="col-span-1">
                    <label class="block font-medium text-gray-700 mb-1">Foto de perfil</label>

                    <div class="mb-3">
                        <img src="{{ asset('assets/images/users/' . ($user->foto_perfil ?? 'avatar-default.png')) }}"
                            class="w-24 h-24 rounded-full object-cover ring ring-gray-300 shadow-sm"
                            alt="Foto de perfil">
                    </div>

                    <input type="file" name="foto_perfil" class="block w-full text-sm text-gray-500
