<x-app-layout>
    ...
    <div class="py-4 max-w-7xl mx-auto">
        ...
        <div id="editUserModal" class="fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-50 hidden">
            <div class="bg-white p-6 rounded-lg w-1/3">
                ...
                <form id="editUserForm" method="POST" action="{{ route('users.update', ['user' => ':userId']) }}">
                    @csrf
                    @method('PUT')
    ...
    <script>
        function openEditModal(userId) {
            ...
            // Actualizar la URL de la acción del formulario con el id del usuario
            document.getElementById('editUserForm').action = "{{ route('users.update', '') }}/" + userData.id;
        }
