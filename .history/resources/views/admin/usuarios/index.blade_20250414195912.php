            ...
            <div class="bg-white p-6 rounded-lg w-1/3">
                ...
                <form id="createUserForm" method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="mb-4 flex items-center">
                        <label for="createIsActive" class="text-sm font-medium text-gray-700 mr-2">Activo</label>
                        <input type="checkbox" id="createIsActive" name="is_active" value="1" class="mt-1">
                    </div>
