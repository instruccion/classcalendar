...
window.addEventListener('DOMContentLoaded', function() {
    ...
    if (!instructorId || !calendarEl) {
        console.log("Agenda Instructor: No hay instructor seleccionado o no se encontró el contenedor del calendario.");
        return;
    }

    console.log('Inicializando FullCalendar para el instructor ID:', instructorId);
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: {
            ...
            method: 'GET',
            extraParams: {
                instructor_id: '{{ $instructor_id }}' // Pasamos el ID del instructor actual
            },
            failure: function() {
                alert('Error cargando eventos del instructor.');
            }
        },
