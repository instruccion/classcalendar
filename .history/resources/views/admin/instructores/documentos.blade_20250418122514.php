...
<script>
    function abrirModalEditar(pivot_id, nombre, fecha) {
        ...
        // ✅ Usa el helper de Laravel para generar la ruta correcta desde Blade
        const actionTemplate = @json(route('admin.instructores.actualizarDocumento', ['pivot' => '__PIVOT__']));

        // ✅ Reemplaza el placeholder por el id real
        form.setAttribute('action', actionTemplate.replace('__PIVOT__', pivot_id));
