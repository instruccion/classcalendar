            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: async function (fetchInfo, successCallback, failureCallback) {
                    try {
                        ...
                        const response = await fetch(`/cursoslaser/public/index.php/api/mi-agenda?instructor_id=${instructorId}`);
                ...
                eventClick: function(info) {
                    ...
                    const contenido = `
                        ...
                        <p><strong>Hora:</strong> ${props.hora_inicio} - ${props.hora_fin}</p>
