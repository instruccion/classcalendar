...
<script>
    function abrirModalEditar(pivot_id, nombre, fecha) {
        ...
        // Generar la base de la URL usando URL::to() + segmento dinámico
        const actionBase = "{{ url('index.php/admin/instructores/documentos') }}/";
        form.setAttribute('action', actionBase + pivot_id);
