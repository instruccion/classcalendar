<x-app-layout>
    ...
    {{-- Script para abrir el modal y setear los valores --}}
    <script>
    function abrirModalEditar(pivot_id, nombre, fecha) {
        const form = document.getElementById('formEditarDocumento');
        const action = "{{ route('admin.instructores.actualizarDocumento', ['pivot' => '__ID__']) }}";
        form.setAttribute('action', `/admin/instructores/documentos/${pivot_id}`);
