    ...
    <div class="py-6 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-4">
            <div class="flex items-center gap-2 flex-wrap justify-center w-full md:w-auto">
                ...
                <form method="GET" action="{{ route('admin.programaciones.index') }}" class="flex flex-wrap items-center gap-2 mb-4">
                    <h1 class="text-2xl font-bold mr-4">Programaciones</h1>
