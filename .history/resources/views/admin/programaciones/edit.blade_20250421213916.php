<x-app-layout>
    ...
    <!-- FullCalendar 6 Global Build -->
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/index.global.min.js"></script>
    <script>
        // ✅ PARA GLOBAL BUILD DE FULLCALENDAR 6
        window.Calendar = FullCalendar.Calendar;
        window.dayGridPlugin = FullCalendar.DayGrid;           // 👈 ojo: con D mayúscula
        window.interactionPlugin = FullCalendar.Interaction;   // 👈 no interactionPlugin
        window.esLocale = FullCalendar.locales['es'];          // 👈 acceder con ['es']
    </script>
...
>
    ...
    <script>
        // 🔧 Asignar correctamente desde el Global Build
        window.Calendar = FullCalendar.Calendar;
        window.dayGridPlugin = FullCalendar.DayGrid;
        window.interactionPlugin = FullCalendar.Interaction;
