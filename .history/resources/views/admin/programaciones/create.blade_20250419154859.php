                        ...
                        fetch(url)
                            ...
                            .then(data => {
                                ...
                                requestAnimationFrame(() => {
                                    ...
                                    try { // <-- Inicio del TRY para renderizado
                                        ...
                                        // Ocultar "Cargando..." DESPUÉS de renderizar
                                        this.isLoadingAvailability = false;
                                        console.log("Alpine: openAvailabilityModal (rAF): isLoadingAvailability puesto a false.");

                                        // $nextTick para asegurar que Alpine procese el cambio de isLoadingAvailability
                                        this.$nextTick(() => {
                                            console.log("Alpine: openAvailabilityModal (rAF): $nextTick ejecutado.");
                                        }); // <-- Llave de cierre CORRECTA para $nextTick

                                    } catch (renderError) { // <-- Llave de cierre para el TRY
                                        ...
                                        // Ocultar "Cargando" también en caso de error
                                        this.isLoadingAvailability = false;
