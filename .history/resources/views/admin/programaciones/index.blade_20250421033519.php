<x-app-layout>
    <div class="py-6 max-w-7xl mx-auto">
        ...
        <div class="bg-white p-4 rounded shadow-md mb-4">
            <form method="GET" action="{{ route('admin.programaciones.index') }}" class="md:flex md:items-end md:justify-between gap-4 flex-wrap">
                ...
                <div class="w-full md:w-auto">
                    ...
                    <select name="grupo_id" id="grupo_id"
                        class="w-full border px-4 py-2 rounded text-sm min-w-[20rem]" {{-- ← Aumentado --}}
