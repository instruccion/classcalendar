<x-app-layout>
    ...
    <script>
        // ✅ Global Build FullCalendar 6 — correcto
        window.Calendar = FullCalendar.Calendar;
        window.dayGridPlugin = FullCalendar.DayGrid; // CORRECTO: es FullCalendar.DayGrid
        window.interactionPlugin = FullCalendar.Interaction;
        window.esLocale = FullCalendar.locales['es']; // CORRECTO: acceder con ['es']
    </script>
