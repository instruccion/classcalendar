                ...
                <tbody>
                    @forelse ($programacionesAgrupadas as $grupoNombre => $bloques)
                        ...
                        <tr class="bg-green-50 font-semibold border-t border-green-200">
                            <td colspan="6" class="px-4 py-2">Grupo: {{ $grupoNombre }}</td>
                        </tr>

                        @foreach ($bloques as $bloqueCodigo => $items)
                            {{-- Nombre del Bloque --}}
                            <tr class="bg-gray-50 text-gray-700 border-t">
                                <td colspan="6" class="flex justify-between items-center px-4 py-2">
                                    <div>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-6 text-center text-gray-500">No hay programaciones disponibles.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
