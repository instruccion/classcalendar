        ...
        <script>
            function programacionForm(config) {
                return {
                    ...
                    instructoresActivos: config.instructoresActivos || [], // Lista completa de activos
                    ...
                    // --- Estado UI & Datos Dinámicos ---
                    availableCourses: [],        // Cursos filtrados por grupo
                    ...
                    formMethod: 'POST',          // Para creación
                    formAction: config.rutasApi.store, // Ruta para guardar nuevo
                    calendarInstance: null,      // Instancia de FullCalendar

                    // --- Métodos ---
                    init() {
                        console.log('Alpine: Formulario inicializado.');
                    },
                    ...
                    loadInstructors() {
                        ...
                        fetch(url)
                            .then(res => res.ok ? res.json() : Promise.reject('Error API Instructores'))
                    ...
                    openAvailabilityModal(type) {
                        ...
                        fetch(url)
                            ...
                            .then(data => {
                                ...
                                requestAnimationFrame(() => { // Usar rAF
