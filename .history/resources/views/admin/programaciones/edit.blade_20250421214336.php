<x-app-layout>
    ...
    <!-- ✅ FullCalendar 6.1.8 Global Build CORRECTA -->
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/index.global.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/locales-all.global.min.js"></script>
    <script>
        // ✅ Asignar para uso global
        ...
        window.esLocale = FullCalendar.globalLocales.find(locale => locale.code === 'es'); // ✅ Correcto para locales-all
    </script>
