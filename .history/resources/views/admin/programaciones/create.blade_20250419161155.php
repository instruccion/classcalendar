        ...
        <script>
            function programacionForm(config) {
                return {
                    ...
                    // ... (código inicial: obtener resourceId, resourceName, modal, etc.) ...
                     const calendarEl = document.getElementById('mini-calendar'); // Obtener elementos ANTES
                    ...
                    calendarEl.innerHTML = ''; tablaDetalleContenido.innerHTML = '<p>Cargando...</p>'; // Limpiar
                    ...
                    fetch(url)
                        ...
                        .then(data => {
                            ...
                            // Usar requestAnimationFrame sigue siendo buena idea para el renderizado
                            requestAnimationFrame(() => {
                                try {
                                    ...
                                    else { /* ... código para generar tablaHtml ... */ tablaDetalleContenido.innerHTML = tablaHtml; }
                                    console.log("Alpine: openAvailabilityModal (rAF) - Tabla OK.");
                                     ...
                                     // --- OCULTAR CARGANDO DESPUÉS DE rAF ---
                        ...
                        .catch(error => {
                             ...
                             // Ocultar cargando y mostrar error en ambos contenedores
                             this.isLoadingAvailability = false;
