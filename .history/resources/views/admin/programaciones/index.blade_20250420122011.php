            ...
            <form method="GET" action="{{ route('admin.programaciones.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                @if(auth()->user()->esAdministrador() && is_null(auth()->user()->coordinacion_id))
                    <div class="md:col-span-1">
                        ...
                        <select name="coordinacion_id" id="coordinacion_id" class="w-full border px-4 py-2 rounded min-w-[12rem]" onchange="this.form.submit()">
                ...
                <div class="md:col-span-1">
                    ...
                    <select name="grupo_id" id="grupo_id" class="w-full border px-4 py-2 rounded min-w-[12rem]" onchange="this.form.submit()">
                ...
                <div class="md:col-span-1 flex items-end justify-end md:justify-start">
