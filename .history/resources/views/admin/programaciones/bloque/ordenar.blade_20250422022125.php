<x-app-layout>
    ...
    <div class="py-6 max-w-6xl mx-auto"
         x-data="ordenarBloque({ cursosIniciales: {{ Js::from($cursosSeleccionados) }}, feriados: {{ Js::from($feriados) }} })"
         x-init="iniciarSortable()">

        <div class="bg-white p-6 rounded shadow-md">
            <div class="mb-6">
                <h1 class="text-2xl font-bold">Paso 2: Reordenar Cursos y Confirmar Detalles</h1>
                <p class="text-sm text-gray-600">Puedes reordenar y preprogramar cursos según la fecha inicial del bloque.</p>
            </div>
        ...
        return {
            ...
            calcularBloque() {
                ...
                this.cursos.forEach((curso) => {
                    const duracionMin = (curso.duracion_horas || 1) * MINUTOS_HORA_ACADEMICA;
            ...
            iniciarSortable() {
                ...
                Sortable.create(el, {
                    ...
                    handle: ".cursor-move",
                    onEnd: (evt) => {
                        const moved = this.cursos.splice(evt.oldIndex, 1)[0];
