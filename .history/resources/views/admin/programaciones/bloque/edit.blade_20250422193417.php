        ...
        <div class="bg-white p-6 rounded shadow-md">
            ...
            <form x-ref="formGuardarBloque" method="POST" :action="rutaUpdateBloque">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Filtrar por Tipo de Curso</label>
                    ...
                    <div>
                        ...
                        <select @change="agregarCurso($event.target.value); $event.target.value = ''"
                            ...
                            <template x-for="c in cursosDisponibles.filter(cc => tipoSeleccionado === '' || cc.tipo === tipoSeleccionado)" :key="c.id">
