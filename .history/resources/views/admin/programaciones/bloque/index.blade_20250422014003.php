...
<x-slot name="header">
    <h2 class="text-xl font-semibold text-gray-800 leading-tight">
        Seleccionar Grupo y Cursos – Programar por Bloque
    </h2>
</x-slot>
    ...
    <div class="py-6 max-w-6xl mx-auto"
        ...
        <div class="bg-white p-6 rounded shadow-md">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600">Puedes reordenar y preprogramar cursos de forma automática según la fecha inicial del bloque.</p>
            </div>
