<x-app-layout>
    ...
    <div class="py-6 max-w-4xl mx-auto">
        ...
        <script>
            function programacionForm(config) {
                ...
                openAvailabilityModal(type) {
                    ...
                    // Obtenemos las referencias ANTES de mostrar el modal y poner en carga
                    ...
                    if (!modal || !calendarEl || !tablaDetalleContenido || typeof modal.showModal !== 'function') {
                        console.error("Alpine: Modal o elementos internos (#mini-calendar, #tabla-detalle-contenido) no encontrados al inicio.");
                    ...
                    calendarEl.innerHTML = ''; // Limpiar por si acaso
                    tablaDetalleContenido.innerHTML = '<p class="text-gray-500 text-sm">Cargando detalles...</p>'; // Poner mensaje de carga en tabla también
                    ...
                    fetch(url)
                        ...
                        .then(data => {
                            ...
                            requestAnimationFrame(() => {
                                ...
                                // No necesitamos buscar los elementos de nuevo aquí, ya los tenemos
                                try {
                                    ...
                                    this.calendarInstance = new window.FullCalendar(calendarEl, { // Usar calendarEl
                                    ...
                                    if (detalles.length === 0) {
                                        ...
                                        tablaDetalleContenido.innerHTML = tablaHtml; // Usar tablaDetalleContenido
                                    }
                                    ...
                                    // Ya no necesitamos el $nextTick aquí porque isLoadingAvailability se establece al final
                                }
                            }); // Fin rAF
                        })
                        .catch(error => {
                            console.error(`Alpine: openAvailabilityModal ERROR fetch (${type}):`, error);
                            // --- OCULTAR CARGANDO Y MOSTRAR ERROR EN CASO DE FALLO FETCH ---
                            this.isLoadingAvailability = false; // <-- Asegurar aquí también
        ...
        <div class="bg-white p-6 rounded shadow-md"
             ...
             @close-dialog.window="console.log('Evento close-dialog recibido para:', $event.detail); document.getElementById($event.detail)?.close()"
        ...
        <dialog id="modalDisponibilidad" class="w-full max-w-4xl p-0 rounded-lg shadow-lg backdrop:bg-black/40">
            <div class="bg-white p-6 relative">
                ...
                <button @click="$dispatch('close-dialog', 'modalDisponibilidad')" class="absolute top-2 right-3 text-gray-600 hover:text-gray-900 text-2xl leading-none">×</button>
