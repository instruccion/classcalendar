    ...
    <div class="py-6 max-w-4xl mx-auto">
                            ...
                            .then(data => {
                                ...
                                requestAnimationFrame(() => {
                                    try {
                                     ...
                                     this.isLoadingAvailability = false; // <-- Correcto en finally
                                     console.log("Alpine: openAvailabilityModal (rAF) - isLoadingAvailability puesto a false (finally).");

                                     // --- $nextTick para forzar actualización del DOM ---
                                     this.$nextTick(() => {
                                         console.log("Alpine: openAvailabilityModal (rAF) - $nextTick post-carga ejecutado.");
                                         // No se necesita hacer nada más aquí dentro
        ...
        <dialog id="modalEventoDetalle" class="w-[90%] max-w-md p-0 rounded-lg shadow-lg backdrop:bg-black/40">
             ...
             <div class="bg-white p-6 text-center relative">
                 ...
                 <button @click="$dispatch('close-dialog', 'modalEventoDetalle')" class="mt-4 bg-gray-300 text-black px-4 py-2 rounded hover:bg-gray-400 transition">
                     Cerrar
                 </button>
             </div>
        </dialog>
