<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800 leading-tight">Cursos Registrados</h2>
    </x-slot>
    ...
    <div class="py-4 max-w-7xl mx-auto">
        <div class="mb-4 flex justify-between items-center">
            ...
            <button onclick="document.getElementById('modalNuevoCurso').showModal()"
                    class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">➕ Registrar Nuevo Curso</button>
        </div>
                ...
                <tbody>
                    @forelse ($cursos as $curso)
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2">{{ $curso->grupos->pluck('nombre')->join(', ') }}</td>
