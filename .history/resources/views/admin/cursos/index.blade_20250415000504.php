        ...
        <form method="GET" class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            @if ($usuario->rol === 'administrador')
                <div>
                    ...
                    <select id="coordinacion" name="coordinacion_id" class="mt-1 block w-full border rounded px-3 py-2" onchange="this.form.submit()">
            ...
            <div>
                ...
                <select name="grupo_id" id="grupo" class="mt-1 block w-full border rounded px-3 py-2" onchange="this.form.submit()">
