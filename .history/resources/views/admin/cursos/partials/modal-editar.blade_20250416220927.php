    ...
    <div class="bg-white p-6">
        ...
        <form method="POST" id="formEditarCurso" class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-12 md:col-span-6">
                <label for="curso_edit_nombre" class="block font-semibold mb-1">Nombre del Curso</label>
            ...
            <div class="col-span-12 md:col-span-4">
                <label for="curso_edit_tipo" class="block font-semibold mb-1">Tipo</label>
                <select name="tipo" id="curso_edit_tipo" required
                        class="w-full border px-4 py-2 rounded">
            ...
            <div class="col-span-12 md:col-span-2">
                <label for="curso_edit_duracion" class="block font-semibold mb-1">Duración (h)</label>
            ...
            <div class="col-span-12">
                <label for="curso_edit_descripcion" class="block font-semibold mb-1">Descripción</label>
