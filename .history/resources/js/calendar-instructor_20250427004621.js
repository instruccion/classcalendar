...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const calendar = new Calendar(calendarEl, {
        ...
        events: function(fetchInfo, successCallback, failureCallback) {
            fetch(window.location.origin + '/cursoslaser/public/index.php/api/instructor-agenda?instructor_id=' + instructorId)
                ...
                .then(data => {
                    ...
                    // Después de cargar cursos, agregamos almuerzos si estamos en vista de semana
                    if (calendar.view.type === 'timeGridWeek') {
                        diasConCursos.forEach(fecha => {
                            calendar.addEvent({
                                ...
                                display: 'background',
                                backgroundColor: '#e5e7eb', // Gris clarito
                                borderColor: '#e5e7eb',
                                textColor: '#4b5563' // Gris oscuro
                            });
                        });
                    }
                })
        ...
        dayCellDidMount(info) {
            ...
            if (day === 0 || day === 6) {
                info.el.style.backgroundColor = '#f8f9fa'; // Sábados y domingos en gris en MES
            }
        },
