...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const instructorId = window.instructorActualId; // Usa la variable JS que pusimos en Blade

    if (!calendarEl || !instructorId) {
        console.log('No hay calendario o instructor ID.');
        return;
    }
    ...
    const calendar = new Calendar(calendarEl, {
        ...
        events: window.location.origin + '/cursoslaser/public/index.php/api/mi-agenda?instructor_id=' + instructorId,
