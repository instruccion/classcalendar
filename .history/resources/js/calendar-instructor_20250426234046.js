...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const calendar = new Calendar(calendarEl, {
        ...
        events: function(fetchInfo, successCallback, failureCallback) {
            fetch(window.location.origin + '/cursoslaser/public/index.php/api/instructor-agenda?instructor_id=' + instructorId)
                ...
                .then(data => {
                    ...
                    // 🔥 Ahora agregamos los eventos de fondo SOLO si estamos en SEMANA
                    if (calendar.view.type === 'timeGridWeek') {
                        ...
                        calendar.addEventSource(fondoEventos);
                    }
                })
                .catch(error => {
        ...
        dayCellDidMount(info) {
            ...
            if (day === 0 || day === 6) {
                info.el.style.backgroundColor = '#f8f9fa'; // Gris clarito en sábado y domingo
            }
        },
        ...
        viewDidMount: function(viewInfo) {
            // 👀 Refrescamos eventos cada vez que cambia de vista
