...
// 🛠️ Importar calendario según la ruta
document.addEventListener('DOMContentLoaded', function () {
    if (window.location.pathname.includes('/mi-agenda')) {
        import('./calendar-instructor.js')
            .then(() => {
                console.log('calendar-instructor.js cargado');
            })
            .catch((err) => {
                console.error('Error al cargar calendar-instructor.js', err);
            });
    } else {
