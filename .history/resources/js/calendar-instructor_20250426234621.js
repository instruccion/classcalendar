...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const diasConCursos = new Set(); // Global temporal
    ...
    const calendar = new Calendar(calendarEl, {
        ...
        dayCellDidMount(info) {
            ...
            if (day === 0 || day === 6) {
                info.el.style.backgroundColor = '#f8f9fa'; // sábado y domingo
            }
        },
        ...
        viewDidMount: function(viewInfo) {
            if (calendar.view.type === 'timeGridWeek') {
                // 👀 SOLO en vista semana agregamos almuerzo
                const fondoEventos = [];
                ...
                // Primero limpiamos fuentes anteriores
                ...
                // Ahora agregamos nuevos almuerzos
