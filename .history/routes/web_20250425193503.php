...
use App\Http\Controllers\ConfirmacionInstructorController;
use App\Http\Controllers\MiAgendaController;
...
Route::middleware(['auth', 'role:administrador,coordinador,analista'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('programaciones/bloque/grupo/{grupo}/codigo/{bloque_codigo?}/edit', [ProgramacionBloqueController::class, 'editBloque'])
     ->name('programaciones.bloque.edit'); // Vista para Editar Bloque

    Route::put('programaciones/bloque/grupo/{grupo}/codigo/{bloque_codigo?}', [ProgramacionBloqueController::class, 'updateBloque'])
      ->name('programaciones.bloque.update'); // Actualizar Bloque existente
    ...
    Route::middleware(['auth', 'role:instructor'])->get('/api/mi-agenda', [\App\Http\Controllers\MiAgendaController::class, 'index'])->name('api.mi-agenda');
...
Route::middleware(['auth', 'role:administrador'])->prefix('admin')->name('admin.')->group(function () {
    Route::get('/agenda-instructor', [ConfirmacionInstructorController::class, 'selectorAgenda'])
    ->name('agenda.instructor');
    ...
    Route::get('/agenda-instructor/{instructor}', [\App\Http\Controllers\MiAgendaController::class, 'agendaInstructor'])->name('agenda.instructor');
    Route::get('instructores/agenda', function () {
        return view('admin.instructores.agenda');
    })->name('instructores.agenda');
