...
Route::middleware(['auth'])->group(function () {
    ...
    // Vista de Mi Agenda (Instructores vinculados)
    Route::get('/mi-agenda', [MiAgendaController::class, 'miAgenda'])->name('instructores.agenda');
    Route::post('/mi-agenda/declinar/{programacion}', [MiAgendaController::class, 'declinarCurso'])->name('mi-agenda.declinar');


    // API para Mi Agenda (datos JSON)
    Route::get('/api/mi-agenda', [MiAgendaController::class, 'index'])->name('api.mi-agenda');
    ...
    Route::get('/mi-agenda/confirmar/{programacion}', [MiAgendaController::class, 'confirmarDesdeCorreo'])->name('mi-agenda.confirmar');

    // Vista de Agenda para Administradores
    Route::get('/instructores/agenda', [MiAgendaController::class, 'agendaAdministrador'])
        ->middleware('role:administrador')
        ->name('admin.instructores.agenda');

    Route::post('/mi-agenda/confirmar/{programacion}', [MiAgendaController::class, 'confirmarCurso'])->name('mi-agenda.confirmar');
