...
// Asegúrate de que la importación del controlador de programaciones esté correcta
...
Route::middleware(['auth', 'role:administrador,coordinador,analista'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::resource('programaciones', ProgramacionController::class); // Nombres: admin.programaciones.*
    ...
    // --- RUTAS API --- (Los nombres tendrán prefijo 'admin.')
    ...
    // Corregido el nombre duplicado en el prompt anterior
...
require __DIR__ . '/auth.php'; // Rutas de Breeze/autenticación
