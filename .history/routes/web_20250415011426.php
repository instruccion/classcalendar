...
Route::prefix('admin')->name('admin.')->middleware('auth')->group(function () {
    ...
    // Esta sí la necesitas para el fetch
    Route::get('/grupos', [GrupoController::class, 'getGruposByCoordinacion'])->name('grupos.byCoordinacion');
});
...
// 🔁 Ruta AJAX para actualizar los grupos desde cursos (fuera del prefijo "admin.")

    Route::get('/grupos-por-coordinacion', [GrupoController::class, 'getGruposByCoordinacion'])
