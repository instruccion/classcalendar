...
use App\Http\Controllers\FeriadoController; // Asegúrate de agregar FeriadoController
...
Route::middleware(['auth', 'role:administrador'])->group(function () {
    ...
    // Feriados con CRUD
    Route::resource('admin/feriados', FeriadoController::class)->parameters(['feriados' => 'feriado'])->names('feriados');
    // Cerrar sesión
