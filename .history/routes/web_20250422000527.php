...
Route::middleware(['auth', 'role:administrador,coordinador,analista'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('programar-bloque', [ProgramacionBloqueController::class, 'index'])
    ...
    Route::post('programaciones/bloque', [ProgramacionBloqueController::class, 'store'])->name('programaciones.bloque.guardar');
