...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6 max-w-6xl mx-auto"
         x-data="bloqueForm({
            ...
            rutaCursos: '<?php echo e(url('admin/programaciones/bloque/cursos')); ?>',
            rutaOrdenar: '<?php echo e(route('admin.programaciones.bloque.ordenar')); ?>'
         })">
        ...
        <div class="bg-white p-6 rounded shadow-md">
            <div class="flex justify-between items-center mb-6 pb-3 border-b">
                ...
                <a href="<?php echo e(route('admin.programaciones.index')); ?>" class="text-blue-600 hover:underline text-sm">
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\cursoslaser\resources\views/admin/programaciones/bloque/index.blade.php ENDPATH**/ ?>